...
angular.module('adminApp').controller('eventController', ["$scope", "$log", "$window", '$routeParams', "auth", 'Content', 'Slide', 'Presentation', 'utils',
function($scope, $log, $window, $routeParams, auth, Content, Slide, Presentation, utils) {
